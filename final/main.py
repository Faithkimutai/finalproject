...
class SignalPage(QWidget):
    def __init__(self, main_app):
        ...
        # Title
        title = QLabel("Vital Signs Analysis")
        ...
        # Next button
        self.next_btn = QPushButton("View Detailed Analysis")
        ...
        self.next_btn.clicked.connect(
            lambda: self.main_app.stack.setCurrentWidget(self.main_app.prediction_page))
    ...
    def display_results(self, image_path, signal_data, red_channel):
        ...
        # Enable next button and start live feed
    ...
    def update_vitals(self):
        ...
        self.bp_pred.setText(f"{np.random.randint(110, 130)}/{np.random.randint(70, 90)}")
